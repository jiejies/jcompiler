...
public class AstToCfgConverterTest {
    ...
    public void testBasicAssignment() {
        ...
        Statement firstStmt = entryBlock.getStatements().get(0);
    ...
    public void testArrayOperations() {
        ...
        // 验证数组创建语句
        Statement newArrayStmt = entryBlock.getStatements().get(0);
        ...
        // 验证数组赋值语句
        Statement arrayAssignStmt = entryBlock.getStatements().get(1);
    ...
    public void testConditionalStatement() {
        ...
        Statement conditionStmt = conditionBlock.getStatements().get(0);
